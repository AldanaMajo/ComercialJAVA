...
public class ConeccionBD {
        ...
        private static final String STR_CONNECTION = "jdbc:sqlserver://ComercialJAVA.mssql.somee.com:1433; " +
                "encrypt=true; " +
                "database=ComercialJAVA; " +
                "trustServerCertificate=true;" +
                "user=MariaAldana_SQLLogin_1;" +
                "password=2wibp6erme";
         ...
         */
        public static synchronized ConeccionBD getInstance() {
